...
void GameOfLife::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GameOfLife *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (GameOfLife::*)(int * * , int * * , int * * , int * * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameOfLife::cellsChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GameOfLife::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_GameOfLife.data,
    qt_meta_data_GameOfLife,
    qt_static_metacall,
    nullptr,
    nullptr
} };
