...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_BrainBWin_t, stringdata) + ofs \
...
const QMetaObject BrainBWin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_BrainBWin.data,
      qt_meta_data_BrainBWin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BrainBWin.stringdata))
