...
public class Wiki2Matrix {
  ...
  public static void main(String[] args) {
    ...
    int[][] kereszt = {
      {0, 2, 2, 3, 2, 2, 3, 3, 2, 2, 3, 1},
      {2, 0, 1, 2, 2, 3, 3, 2, 3, 3, 1, 1},
      {3, 2, 0, 2, 2, 2, 2, 2, 3, 2, 2, 3},
      {1, 3, 2, 0, 1, 1, 1, 1, 1, 2, 3, 1},
      {2, 2, 1, 2, 0, 2, 3, 2, 2, 2, 3, 1},
      {2, 3, 1, 2, 1, 0, 1, 2, 3, 2, 1, 2},
      {3, 2, 1, 2, 1, 3, 0, 1, 2, 2, 3, 1},
      {1, 2, 1, 2, 3, 1, 3, 0, 1, 2, 2, 1},
      {2, 1, 1, 3, 3, 2, 2, 2, 0, 2, 3, 1},
      {1, 2, 2, 2, 2, 3, 2, 1, 3, 0, 1, 2},
      {2, 2, 1, 2, 3, 2, 3, 1, 3, 2, 0, 2},
      {3, 1, 2, 2, 2, 2, 2, 1, 3, 1, 2, 0},
    };
